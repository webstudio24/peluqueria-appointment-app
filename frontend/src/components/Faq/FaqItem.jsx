...
const FaqItem = ({ item }) => {
  ...
  return (
    <div className="p-3 lg:p-5 rounded-[12px] border-solid border-[#d9dce2] mb-5 cursor-pointer border">
      <div className="flex items-center justify-between gap-5" onClick={toggleAccordion}>
        ...
        {isOpen && <div> 
            <p className="text-[14px] lg:text-[16px] lg:leading-7 font-[400] text-textColor">{item.content}</p>
