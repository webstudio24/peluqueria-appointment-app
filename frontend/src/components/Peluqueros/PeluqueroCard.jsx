...
const PeluquerosCard = ({peluquero}) => {
  const {name, avgRating, totalRating, photo, specialization, totalPatients, sucursal} = peluquero;

  return (
    <div className="p-3 lg:p-5">
      <img src={photo} alt=""  className="rounded-3xl w-full"/>
      ...
      <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
        <div>
          <h3 className="text-[16px] leading-7 lg:text-[18px] lg:leading-[30px] font-semibold text-headingColor" >+{totalPatients} clientes</h3>
          <p className="text-[14px] leading-6 font-[400] text-textColor">En {sucursal}</p>
        </div>
